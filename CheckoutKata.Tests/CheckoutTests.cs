...
namespace CheckoutKata.Tests
{
    ...
    public class CheckoutTests
    {
        ...
        [TestMethod]
        public void WhenIScanFourOfTheSameItemsThenTheTotalPriceShoulBeTheSpecialPricePlusTheUnitPriceForOne()
        {
            string sku = "a";
        ...
        [TestMethod]
        public void WhenIScanMultipleItemsThenTheTotalPriceShoulBeUpdated()
        {
            string sku = "a";
            string b = "b";
        ...
        [TestMethod]
        public void WhenIScanAllItemsThenTheTotalPriceShoulBeUpdated()
        {
            string sku = "a";
            string b = "b";
            string c = "c";
        ...
        [TestMethod]
        public void WhenIScanAllItemsMultipleTimesThenTheTotalPriceShoulBeUpdated()
        {
            string sku = "a";
            string b = "b";
            string c = "c";
